 ...
 */
public class AnimationsDemoMain extends ListActivity {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acticity_animations_demo);
    ...
    protected void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        startActivity(new Intent(AnimationsDemoMain.this, mSamples[position].activityClass));
    }
