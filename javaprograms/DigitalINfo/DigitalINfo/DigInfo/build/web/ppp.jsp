...
<html>
    ...
    <jsp:useBean id="upBean" scope="page" class="javazoom.upload.UploadBean" >
        <jsp:setProperty name="upBean" property="folderstore" value="C:/Users/SattvaQ7/Desktop/DigitalINfo/DigitalINfo/DigInfo/web/certificates"/>
    ...
    String  data,orgname,year,htno,loc;
         ...
         String contact=mrequest.getParameter("con");
...
String q = "insert into educationdata values('0','" + data + "','" + orgname + "','" + year + "','"+htno+"','"+loc+"','"+per+"','"+"certificates/"+file.getFileName()+"','"+suid+"','"+contact+"')";
            java.sql.Statement st = mycon.createStatement();
            int i = st.executeUpdate(q);
if(i>0){
    javax.servlet.RequestDispatcher rd=request.getRequestDispatcher("addedu.jsp");
