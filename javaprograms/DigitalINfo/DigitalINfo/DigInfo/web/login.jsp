            ...
            <div class="pad_left1">
              ...
              <form id="ContactForm" action="loginaction">
                <div>
                  ...
                  <div  class="wrapper"> <strong>User:</strong>
                    <div class="bg" class="dropdown">
                        <select name="typeofuser" id="ex3select1">
               ...
               <input type="reset" class="button" value="Clear"><input type="submit" class="button" value="Login"> </div>
              </form>
            </div>
          </article>
