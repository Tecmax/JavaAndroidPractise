...
if(request.getParameter("otp")!=null){
    ...
    String sotp=session.getAttribute("otp").toString();
    ...
    <h2 style="color:red;">Try Again : Wrong OTP</h2>
    <%
     ...
     <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2>OTP Form</h2>
              <h3>Check your mail for OTP</h3>
              <form id="ContactForm" action="otp.jsp">
                <div>
                  
                  <div  class="wrapper"> <strong>Enter OTP:</strong>
                    <div class="bg">
