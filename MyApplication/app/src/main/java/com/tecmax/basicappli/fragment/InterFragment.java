 ...
 * {@link InterFragment.OnFragmentInteractionListener} interface
...
public class InterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView view = v.findViewById(R.id.click);
        Snackbar.make(v, "Text is " + mParam1 + mParam2, Snackbar.LENGTH_SHORT).show();

        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onButtonPressed(null, "Rahul ");
            }
        });
        return v;
    }
    ...
    public void onButtonPressed(Uri uri, String name) {
        if (mListener != null) {
            mListener.onFragmentInteraction(name, uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onFragmentInteraction(String name, Uri uri);
    }
}
