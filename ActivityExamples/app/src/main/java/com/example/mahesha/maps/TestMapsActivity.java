...
public class TestMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng tecmax = new LatLng(12.9538, 77.35074);

        MarkerOptions marker = new MarkerOptions().position(tecmax).title("Tecmax");
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLng(tecmax));
