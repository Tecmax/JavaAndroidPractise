...
<html>
    ...
    <%
        ...
        urlpath = urlpath + "/cards";
    %>
    <jsp:useBean id="upBean" scope="page" class="javazoom.upload.UploadBean" >
        <jsp:setProperty name="upBean" property="folderstore" value="C:/Users/SattvaQ7/Desktop/DigitalINfo/DigitalINfo/DigInfo/web/cards"/>
    ...
    String  data,name,cno,htno,loc;
          data=mrequest.getParameter("data");
          name=mrequest.getParameter("name");
          cno=mrequest.getParameter("cno");
        
          loc=mrequest.getParameter("loc");
          //String     con=mrequest.getParameter("con");
...
String q = "insert into carddetails values('" + data + "','" + suid + "','" + name + "','"+cno+"','"+loc+"','"+"cards/"+file.getFileName()+"')";
            java.sql.Statement st = mycon.createStatement();
            int i = st.executeUpdate(q);
if(i>0){
    javax.servlet.RequestDispatcher rd=request.getRequestDispatcher("addcard.jsp");
                       request.setAttribute("remsg", "File Uploaded Successfully !");
