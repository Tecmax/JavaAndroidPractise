...
public class SharedUtils {
    ...
    public static void storeImageName(Context context, String name) {
        context.getSharedPreferences(ConstantProperties.USER_FILE,
                Context.MODE_PRIVATE).edit()
                .putString(USERID, name).apply();
    }


    public static String getUserName(Context context) {
        return context.getSharedPreferences("US",
                Context.MODE_PRIVATE).getString(
                USER_NAME, null);
    }

    public static void storeUserName(Context context, String name) {
        context.getSharedPreferences("US",
                Context.MODE_PRIVATE).edit()
    ...
    public static void saveRememberMe(Context context, boolean isLoginDisabled) {
        context.getSharedPreferences(ConstantProperties.USER_FILE, Context.MODE_PRIVATE)
